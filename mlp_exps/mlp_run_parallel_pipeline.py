...
#Run this code with 
# python3 mlp_run_parallel_pipeline.py --config configs/zurcher_config_240909.json > main_output.log 2>&1 &

import torch
import argparse
import json
import mlp_collect_data, mlp_train
import ray
...
def run_data_generation_and_training(config):
    ...
    mlp_collect_data.generate(config)
