...
from mlp.multiHeadedMLPModule import MultiHeadedMLPModule
...
class MLP(MultiHeadedMLPModule):
    ...
    def __init__(self,
                 ...
                 hidden_b_init=-40+nn.init.zeros_,
        ...
        super().__init__(2, states_dim, [actions_dim, actions_dim], hidden_sizes,
                         ...
                         layer_normalization) #fix n_heads to 2 (q and v heads) 
    ...
    def forward(self, x):
        ...
        q_values, vnext_values = super().forward(states)
