#python3 run_airline_ray.py --config configs/airline_241019.json
import torch
import argparse
import json
import airline_train, airline_generate
import ray
import os
...
if __name__ == "__main__":
    ...
    zurcher_config = full_config['airline_config']
