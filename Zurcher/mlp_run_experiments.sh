...
screen -dmS $screen_name bash -c "
    ...
    python3 mlp_run_parallel_pipeline.py --config configs/zurcher_mlp_240909.json > mlp_exps/logs/main_output_${timestamp}.log 2>&1
...
#Run the code with ./mlp_run_experiments.sh